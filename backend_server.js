...
// Note: In Docker containers, JWT_SECRET is generated by the entrypoint script
if (!process.env.JWT_SECRET || process.env.JWT_SECRET.trim() === '') {
  console.error('💥 ERROR: JWT_SECRET environment variable is required!');
  console.error('Generate a secure secret with: openssl rand -base64 64');
  console.error('Note: In Docker, JWT_SECRET should be auto-generated by the entrypoint script');
  process.exit(1);
}
